...
//                scale:Qt.vector3d(sliderScale1.sliderValue,sliderScale2.sliderValue,sliderScale3.sliderValue)
                ...
                ShapePath {
                    ...
                    startX: vecs2[0].x
                    startY: -vecs2[0].y
                    PathLine { x: vecs2[1].x; y: -vecs2[1].y }
                    PathLine { x: vecs2[2].x; y: -vecs2[2].y }
                    PathLine { x: vecs2[3].x; y: -vecs2[3].y }
                    PathLine { x: vecs2[4].x; y: -vecs2[4].y }
                    PathLine { x: vecs2[5].x; y: -vecs2[5].y }
                    PathLine { x: vecs2[6].x; y: -vecs2[6].y }
                    PathLine { x: vecs2[7].x; y: -vecs2[7].y }
                    PathLine { x: vecs2[8].x; y: -vecs2[8].y }
                }
                ShapePath {
                    strokeColor: "black"
                    strokeWidth: 2
                    ...
                    startX: vecs2[9].x
                    startY: -vecs2[9].y
                    PathLine { x: vecs2[10].x; y: -vecs2[10].y }
                    PathLine { x: vecs2[11].x; y: -vecs2[11].y }
                    PathLine { x: vecs2[9].x; y: -vecs2[9].y }
                }
